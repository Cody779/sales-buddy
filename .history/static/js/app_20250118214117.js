    ...
    async function startRecording() {
        ...
        try {
            ...
            mediaRecorder.addEventListener('stop', async () => {
                ...
                try {
                    // Show audio preview container first
                    audioPreview.style.display = 'block';
                    
                    // Create a temporary audio element and wait for metadata to load
                    const duration = await new Promise((resolve, reject) => {
                        const temp = new Audio();
                        temp.addEventListener('loadedmetadata', () => {
                            console.log('Audio metadata loaded, duration:', temp.duration);
                            if (isFinite(temp.duration)) {
                    ...
                    console.log('Confirmed duration:', duration);
                    ...
                    // Clear and append the custom player
