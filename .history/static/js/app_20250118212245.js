...
function initializeApp() {
    ...
    async function startRecording() {
        ...
        if (existingMessage) {
            ...
            // Only show placeholder if there's no transcription yet
        ...
        try {
            ...
            mediaRecorder.addEventListener('stop', async () => {
                ...
                // Wait for metadata to load before showing player
                await new Promise((resolve, reject) => {
                    const onLoadedMetadata = () => {
                        try {
                            ...
                            console.log('Audio duration:', formattedTime);
                            resolve();
                        } catch (error) {
                            reject(error);
                        }
                    ...
                    // Add error handling
                    audioPlayer.addEventListener('error', (e) => reject(new Error('Error loading audio: ' + e.message)), { once: true });
                }).catch(error => {
