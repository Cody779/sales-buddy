                ...
                try {
                    await new Promise((resolve, reject) => {
                        tempAudio.addEventListener('loadedmetadata', () => {
                            ...
                            // Find the duration display element and update it
                            const durationDisplay = audioPlayer.parentElement.querySelector('.duration');
                            if (durationDisplay) {
                                durationDisplay.textContent = formattedTime;
                            }
                            
                            console.log('Audio duration loaded:', formattedTime);
                            resolve();
                        }, { once: true });
