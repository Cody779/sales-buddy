    ...
    function updateStatus(message) {
        ...
        if (status) {
            if (message) {
                ...
                // Ensure status message is in the correct position
                const chatContainer = document.querySelector('.chat-container');
                if (chatContainer && status.parentElement !== chatContainer) {
                    // Move status message to be the first child of chat container
